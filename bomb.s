...
080494ee <phase_2>:
 ...
 8049509:	85 c0                	test   %eax,%eax;eax!=0
 ...
 804952a:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp);1
 8049531:	eb 36                	jmp    8049569 <phase_2+0x7b>
 8049533:	8b 45 f4             	mov    -0xc(%ebp),%eax
 8049536:	8b 54 85 d0          	mov    -0x30(%ebp,%eax,4),%edx;next number
 804953a:	8b 45 f4             	mov    -0xc(%ebp),%eax
 804953d:	83 e8 01             	sub    $0x1,%eax
 8049540:	8b 4c 85 d0          	mov    -0x30(%ebp,%eax,4),%ecx;curr number
 8049544:	8b 5d f4             	mov    -0xc(%ebp),%ebx;count:1...
 8049547:	b8 00 00 00 00       	mov    $0x0,%eax
 804954c:	29 d8                	sub    %ebx,%eax;eax:-count
 804954e:	01 c0                	add    %eax,%eax
 8049550:	01 c8                	add    %ecx,%eax;-2*count+curr
 8049552:	83 c0 01             	add    $0x1,%eax;-2*count+curr+1==next
 ...
 8049569:	83 7d f4 08          	cmpl   $0x8,-0xc(%ebp);<=8
...
08049871 <phase_6>:
 ...
 8049877:	c7 45 e8 30 c1 04 08 	movl   $0x804c130,-0x18(%ebp)
 804987e:	83 ec 04             	sub    $0x4,%esp
 8049881:	6a 07                	push   $0x7
 8049883:	8d 45 cc             	lea    -0x34(%ebp),%eax
 8049886:	50                   	push   %eax
 8049887:	ff 75 08             	pushl  0x8(%ebp)
 ...
 8049918:	8b 45 e8             	mov    -0x18(%ebp),%eax
 804991b:	89 45 f4             	mov    %eax,-0xc(%ebp)
 804991e:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
 8049925:	eb 0d                	jmp    8049934 <phase_6+0xc3>
 8049927:	8b 45 f4             	mov    -0xc(%ebp),%eax
 804992a:	8b 40 08             	mov    0x8(%eax),%eax
 804992d:	89 45 f4             	mov    %eax,-0xc(%ebp)
 8049930:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
 8049934:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8049937:	8b 44 85 cc          	mov    -0x34(%ebp,%eax,4),%eax
 804993b:	39 45 ec             	cmp    %eax,-0x14(%ebp)
 804993e:	7c e7                	jl     8049927 <phase_6+0xb6>
 8049940:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8049943:	8b 55 f4             	mov    -0xc(%ebp),%edx
 8049946:	89 54 85 b0          	mov    %edx,-0x50(%ebp,%eax,4)
 804994a:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
 804994e:	83 7d f0 06          	cmpl   $0x6,-0x10(%ebp)
 8049952:	7e c4                	jle    8049918 <phase_6+0xa7>
 8049954:	8b 45 b0             	mov    -0x50(%ebp),%eax
 8049957:	89 45 e8             	mov    %eax,-0x18(%ebp)
 804995a:	8b 45 e8             	mov    -0x18(%ebp),%eax
 804995d:	89 45 f4             	mov    %eax,-0xc(%ebp)
 8049960:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
 8049967:	eb 1a                	jmp    8049983 <phase_6+0x112>
 8049969:	8b 45 f0             	mov    -0x10(%ebp),%eax
 804996c:	8b 54 85 b0          	mov    -0x50(%ebp,%eax,4),%edx
 8049970:	8b 45 f4             	mov    -0xc(%ebp),%eax
 8049973:	89 50 08             	mov    %edx,0x8(%eax)
 8049976:	8b 45 f4             	mov    -0xc(%ebp),%eax
 8049979:	8b 40 08             	mov    0x8(%eax),%eax
 804997c:	89 45 f4             	mov    %eax,-0xc(%ebp)
 804997f:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
 8049983:	83 7d f0 06          	cmpl   $0x6,-0x10(%ebp)
 8049987:	7e e0                	jle    8049969 <phase_6+0xf8>
 8049989:	8b 45 f4             	mov    -0xc(%ebp),%eax
 804998c:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
 8049993:	8b 45 e8             	mov    -0x18(%ebp),%eax
 8049996:	89 45 f4             	mov    %eax,-0xc(%ebp)
 8049999:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
 80499a0:	eb 2a                	jmp    80499cc <phase_6+0x15b>
 80499a2:	8b 45 f4             	mov    -0xc(%ebp),%eax
 80499a5:	8b 10                	mov    (%eax),%edx
 80499a7:	8b 45 f4             	mov    -0xc(%ebp),%eax
 80499aa:	8b 40 08             	mov    0x8(%eax),%eax
 80499ad:	8b 00                	mov    (%eax),%eax
 80499af:	39 c2                	cmp    %eax,%edx
 ...
 80499bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
 80499c2:	8b 40 08             	mov    0x8(%eax),%eax
 80499c5:	89 45 f4             	mov    %eax,-0xc(%ebp)
 80499c8:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
 80499cc:	83 7d f0 05          	cmpl   $0x5,-0x10(%ebp)
...
080499d9 <fun7>:
 ...
 8049a20:	8b 45 08             	mov    0x8(%ebp),%eax
 8049a23:	8b 40 08             	mov    0x8(%eax),%eax
 8049a26:	83 ec 08             	sub    $0x8,%esp
 8049a29:	ff 75 0c             	pushl  0xc(%ebp)
 8049a2c:	50                   	push   %eax
 8049a2d:	e8 a7 ff ff ff       	call   80499d9 <fun7>
 8049a32:	83 c4 10             	add    $0x10,%esp
 8049a35:	01 c0                	add    %eax,%eax
 8049a37:	83 c0 01             	add    $0x1,%eax
 8049a3a:	c9                   	leave  
 8049a3b:	c3                   	ret    
...
08049a3c <secret_phase>:
 ...
 8049a47:	89 45 f4             	mov    %eax,-0xc(%ebp)
 8049a4a:	83 ec 0c             	sub    $0xc,%esp
 8049a4d:	ff 75 f4             	pushl  -0xc(%ebp)
 8049a50:	e8 ab f6 ff ff       	call   8049100 <atoi@plt>
 8049a55:	83 c4 10             	add    $0x10,%esp
 8049a58:	89 45 f0             	mov    %eax,-0x10(%ebp)
 8049a5b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 8049a5f:	7e 09                	jle    8049a6a <secret_phase+0x2e>
 8049a61:	81 7d f0 e9 03 00 00 	cmpl   $0x3e9,-0x10(%ebp)
 ...
 8049a79:	ff 75 f0             	pushl  -0x10(%ebp)
 8049a7c:	68 e4 c1 04 08       	push   $0x804c1e4
 8049a81:	e8 53 ff ff ff       	call   80499d9 <fun7>
 8049a86:	83 c4 10             	add    $0x10,%esp
 8049a89:	89 45 ec             	mov    %eax,-0x14(%ebp)
 8049a8c:	83 7d ec 02          	cmpl   $0x2,-0x14(%ebp)
...
08049ef2 <phase_defused>:
 ...
 8049ef8:	a1 4c c2 04 08       	mov    0x804c24c,%eax
 8049efd:	83 f8 07             	cmp    $0x7,%eax
 ...
 8049f10:	50                   	push   %eax
 8049f11:	68 ce a3 04 08       	push   $0x804a3ce
